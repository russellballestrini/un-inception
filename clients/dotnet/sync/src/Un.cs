...
Args ParseArgs(string[] args)
{
    ...
    for (var i = 0; i < args.Length; i++)
    {
        ...
        else if (arg == "-l" || arg == "--list") { if (result.Command == "session") result.SessionList = true; else if (result.Command == "service") result.ServiceList = true; }
...
class Args
{
    ...
    public string? ServiceName, ServicePorts, ServiceBootstrap, ServiceType;
